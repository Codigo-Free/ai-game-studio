...
- **Fase:** 1 (MVP) — **M0–M5 completados** (M5 validado el 2026-07-03: proyecto con behaviors abierto, guardado canónico desde el editor y juego menú+nivel ejecutado); en curso: **M6 (Demo, calidad y release 0.1)**.
