...
- **Fase 1 (MVP) COMPLETADA** — release **v0.1.0** publicado el 2026-07-03 con instaladores del editor (deb/rpm/AppImage, msi/exe, dmg/app) y binarios del CLI para 3 SO. Siguiente: **Fase 2 (Motor completo)** — animaciones avanzadas (spritesheets, curvas, máquinas de estados), física 2D, audio, partículas, scripting y exportador Desktop.
