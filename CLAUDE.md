...
- **Fase 2 (Motor completo) en curso** — plan en `docs/plan.md` (M7–M13). **M7, M8 y M9 completados**; siguiente: **M10 (Spritesheets y animación avanzada)**.
