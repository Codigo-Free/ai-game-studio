...
- **Fase:** 1 (MVP) — **M0–M3 completados** (M3 validado manualmente el 2026-07-03: proyecto abierto en el editor, entidad movida en el viewport, guardado canónico y Play ejecutando la escena en el runtime); siguiente: **M4 (Timeline y animación)**.
